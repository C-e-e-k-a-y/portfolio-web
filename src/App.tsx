...
function App() {
  ...
  return (
    <div
      className="h-screen bg-cover bg-center bg-no-repeat snap-y snap-mandatory scroll-smooth overflow-auto scrollbar-none p-8 md:p-[5%] text-white"
      style={{ backgroundImage: `url(${introBg})` }}
    >

      <Section id="home" className="my-auto h-screen snap-start flex items-center justify-center transition ease-in-out duration-500">
      ...
      <Section id="about" className="h-screen my-auto flex items-center justify-center snap-start space-y-4 lg:space-x-10 lg:flex-row flex-col">
      ...
      <Section id="projects" className="h-screen my-auto flex items-center justify-center snap-start">
      ...
      <Section id="contact" className="h-screen my-auto flex items-center justify-center snap-start">
        <div className="text-center">
